...
public class HttpTool {
	...
	public static String getUserDetail(String access_token, String openid) {
		String requestUrl = oauth_info.replace("ACCESS_TOKEN", access_token)
				.replace("OPENID", openid);
		JSONObject jsonObject = httpRequest(requestUrl, "GET", null);
		return jsonObject.toString();
	}

	public static String getUserDetailByUUnionID(String access_token,
			String openid) {
		String requestUrl = unionID_info.replace("ACCESS_TOKEN", access_token)
				.replace("OPENID", openid);
		JSONObject jsonObject = httpRequest(requestUrl, "GET", null);
		return jsonObject.toString();
	}
