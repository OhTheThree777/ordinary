/*! Amaze UI v2.7.0 ~ Handlebars helper | by Amaze UI Team | (c) 2016 AllMobilize, Inc. | Licensed under MIT | 2016-05-24T10:02:50+0800 */
		(function(i) {
			"use strict";
			var n = function(i) {
				i.registerHelper("ifCond", function(i, n, t, a) {
					switch (n) {
					case "==":
						return i == t ? a.fn(this) : a.inverse(this);
					case "===":
						return i === t ? a.fn(this) : a.inverse(this);
					case "<":
						return t > i ? a.fn(this) : a.inverse(this);
					case "<=":
						return t >= i ? a.fn(this) : a.inverse(this);
					case ">":
						return i > t ? a.fn(this) : a.inverse(this);
			...
			"undefined" != typeof module && module.exports
					&& (module.exports = n), this.Handlebars
					&& n(this.Handlebars)
		}).call(this),
		function(i) {
			"use strict";
