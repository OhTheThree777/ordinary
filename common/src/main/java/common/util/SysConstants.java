...
public class SysConstants {
	 ...
	 * 用户客户端主机IP地址的Key
	 */
	public static final String SESSION_IPADD_KEY = "user_client_host_ip";

	/**
	 * Shiro Realm name
	 */
	public static final String SHIRO_REALM_NAME = "commonRealm";

	/**
	 * 登录验证码默认Session Key
	 */
	public static final String VALIDATE_CODE_KEY = "calidateCodeKey";

	/**
	 * 项目的类路径的根
	 */
	public static final String CLASS_PATH_ROOT = "cn.lr.";
