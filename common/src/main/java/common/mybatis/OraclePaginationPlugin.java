...
public class OraclePaginationPlugin extends PluginAdapter {
	...
	private final String packagePage = "cn.lr.common.util";
	...
	private void addPage(TopLevelClass topLevelClass,
		...
		topLevelClass.addImportedType(new FullyQualifiedJavaType(packagePage));
		...
		method = new Method();
		method.setVisibility(JavaVisibility.PUBLIC);
		method.setReturnType(new FullyQualifiedJavaType(packagePage));
